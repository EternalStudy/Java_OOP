...
public class Persona extends FamilyTree implements Finder{
    private List<Persona> children = new ArrayList<>(null);
    private List<Persona> parents = new ArrayList<>(null);
